            ...
            <div style={{ display: "flex" }}>
                ...
                {[
                    ...
                    <Card
                        ...
                        className="mb-2"
                    >
                        <Card.Header style={{ fontSize: "50px" }}>WishList Management</Card.Header>
                        <Card.Body>
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <Row>
                                        <Col md style={{ marginTop: "1%" }} >
                                            <Button type='submit' variant="success" style={{ float: "right", marginLeft: "1%" }} >{currentId == 0 ? "Create WishList" : "Update WishList"}</Button>
